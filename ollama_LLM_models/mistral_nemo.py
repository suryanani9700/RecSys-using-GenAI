...
st.title("Amazon Shopping Recommendation with mistral-nemo")
...
def load_or_create_faiss_index():
    ...
    if os.path.exists(FAISS_INDEX_PATH):
        faiss_index = FAISS.load_local(
            FAISS_INDEX_PATH,
            OllamaEmbeddings(model="mistral-nemo"),  # Removed batch_size here
        ...
        docs = loader.load()
        embeddings_model = OllamaEmbeddings(model="mistral-nemo")  # Removed batch_size here
