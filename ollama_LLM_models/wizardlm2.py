...
st.title("Amazon Shopping Recommendation with wizardlm2")
...
def load_or_create_faiss_index():
    ...
    if os.path.exists(FAISS_INDEX_PATH):
        faiss_index = FAISS.load_local(
            FAISS_INDEX_PATH,
            OllamaEmbeddings(model="wizardlm2"),  # Removed batch_size here
        ...
        docs = loader.load()
        embeddings_model = OllamaEmbeddings(model="wizardlm2")  # Removed batch_size here
