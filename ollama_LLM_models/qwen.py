...
st.title("Amazon Shopping Recommendation with qwen2.5")
...
def load_or_create_faiss_index():
    ...
    if os.path.exists(FAISS_INDEX_PATH):
        faiss_index = FAISS.load_local(
            FAISS_INDEX_PATH,
            OllamaEmbeddings(model="qwen2.5"),  # Removed batch_size here
        ...
        docs = loader.load()
        embeddings_model = OllamaEmbeddings(model="qwen2.5")  # Removed batch_size here
